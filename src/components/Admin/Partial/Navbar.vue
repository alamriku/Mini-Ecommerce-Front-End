<template>
    <div class="sticky top-0 z-40 ">
            <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between bg">
              ...
              <div class="flex">
                ...
                <div class="relative text-gray-600">
                  ...
                  <router-link :to="{ name:'Items'}" class=" ml-2 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                      Website
                  </router-link>
              </div>
